"""
This script aims to generate a walking cycle for a planar full body model with 1 soft contact per foot.
The stick model is torque driven and has 9 degrees of freedom: 3 unactuated (free floating base) and
6 actuated (elbows 2, hips 2, knees 2).
...
if __name__ == "__main__":
    ...
    # run_walker(dynamics_transcription, discretization_method)
    #
    ...
    # dynamics_transcription = DirectCollocationTrapezoidal()
    # discretization_method = MeanAndCovariance(dynamics_transcription)
    # run_walker(dynamics_transcription, discretization_method, with_lbq_bound=True)
    #
