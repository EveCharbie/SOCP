...
class Variational(TranscriptionAbstract):
    ...
    def set_three_node_defect(
        ...
        three_nodes_defect_func = cas.Function(
            ...
            [
                ...
                cas.vertcat(*variables_vector.get_states_list(node=2)),
                cas.vertcat(*variables_vector.get_states_list(node=3)),
    ...
    def set_initial_defect(
        ...
        d2_l_q0_qdot0 = self.discretization_method.get_lagrangian_jacobian(
            ocp_example,
        ...
        # discrete Lagrangian)
        d1_ld_q0_q1 = self.discretization_method.get_lagrangian_jacobian(
            ocp_example,
            discrete_lagrangian_previous,
        ...
        initial_defect_func = cas.Function(
            ...
            [
                ...
                cas.vertcat(*variables_vector.get_states_list(node=0)),
                cas.vertcat(*variables_vector.get_states_list(node=1)),
    ...
    def set_final_defect(
        ...
        discrete_lagrangian_qdotN = lagrangian_func(
            q=variables_vector.get_state("q", 2),
            qdot=qdotN,
            u=variables_vector.get_controls(2),
        )["L"]
        d2_l_q_ultimate_qdot_ultimate = self.discretization_method.get_lagrangian_jacobian(
            ocp_example,
            discrete_lagrangian_qdotN,
            qdotN,
        )
        # Refers to D_2 L_d(q_{n-1}, q_1) (Ld is the discrete Lagrangian)
        d2_ld_q_penultimate_q_ultimate = self.discretization_method.get_lagrangian_jacobian(
            ocp_example,
            discrete_lagrangian_current,
        ...
        final_defect_func = cas.Function(
            ...
            [
                ...
                cas.vertcat(*variables_vector.get_states_list(1)),
    ...
    def set_cov_constraint(
        ...
        if ocp_example.model.use_sx:
            ...
            z = cas.MX.sym("z_three", ocp_example.model.nb_q * 3)
        z_three = cas.horzcat(
        ...
        cov_constraint = cov_integrated_vector - variables_vector.get_cov(1)
    ...
    def set_initial_cov_constraint(
        ...
        # Refers to D_2 L(q_0, \dot{q_0}) (D_2 is the partial derivative with respect to the second argument)
        discrete_lagrangian_qdot0 = self.discretization_method.get_lagrangian(
            ocp_example=ocp_example,
            q=z_three[:, 0],
        ...
        cov_constraint_initial = cov_integrated_vector - variables_vector.get_cov(1)
    ...
    def set_final_cov_constraint(
        ...
        if ocp_example.model.use_sx:
            ...
            z = cas.MX.sym("z_final", ocp_example.model.nb_q, 3)
        z_final = cas.horzcat(
            z[: ocp_example.model.nb_q],
            z[ocp_example.model.nb_q : 2 * ocp_example.model.nb_q],
            z[2 * ocp_example.model.nb_q :],
        )
        F = z_final[:, 2]  # Should be a function all z
        ...
        final_defect_z = self.final_defect_func(
            ...
            z_final[:, 1],
            variables_vector.get_state("qdot", ocp_example.n_shooting),
            variables_vector.get_states_list(1),
        ...
        G += [final_defect_z]
        G += [z_final[:, 2] - variables_vector.get_state("q", 2)]
        ...
        sigma_ww_1 = noises_vector.get_noise_matrix(1).T @ noises_vector.get_noise_matrix(1)
    ...
    def set_dynamics_constraints(
        ...
        initial_defect = self.initial_defect_func(
            ...
            variables_vector.get_state("q", 1),
            variables_vector.get_state("qdot", 0),
            variables_vector.get_padded_states(0),
        ...
        three_nodes_defects = multi_threaded_constraint(
            ...
            cas.horzcat(*[variables_vector.get_padded_states(i_node) for i_node in range(0, n_shooting - 1)]),
            cas.horzcat(*[variables_vector.get_padded_states(i_node) for i_node in range(1, n_shooting)]),
            cas.horzcat(*[variables_vector.get_padded_states(i_node) for i_node in range(2, n_shooting + 1)]),
        ...
        if self.discretization_method.name == "MeanAndCovariance":
            ...
            cov_constraint = multi_threaded_constraint(
                variables_vector.get_time(),
                cas.horzcat(*[variables_vector.get_padded_states(i_node) for i_node in range(0, n_shooting)]),
                cas.horzcat(*[variables_vector.get_padded_states(i_node) for i_node in range(1, n_shooting + 1)]),
                cas.horzcat(
                    *[
                        cas.vertcat(
        ...
        final_defect = self.final_defect_func(
            ...
            variables_vector.get_padded_states(n_shooting - 1),
