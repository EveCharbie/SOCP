"""
This model was adapted from Puchaud & al. 2023 https://doi.org/10.1016/j.cma.2023.116162
"""
    ...
    def dynamics(
        ...
        if with_q_qdot:
            ...
            if self.nb_random == 1:
                ...
                q=q,
                qdot=qdot,
                tau="TODO", # TODO: see if tau isneeded for foot pressure
